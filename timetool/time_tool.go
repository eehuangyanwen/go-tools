...
func GetDayOfMonth() (day int) {
	day = time.Now().Day()
	return
}

func GetHour() (hour int) {
	hour = time.Now().Hour()
	return
}

func GetMinute() (minute int) {
...
const (
	DEFAULT_FORMAT_19 = "yyyy-MM-dd HH:mm:ss"
	DEFAULT_FORMAT_10 = "yyyy-MM-dd"
)
...
func GetDefaultTime() (str string) {
	str = Format(Now(), DEFAULT_FORMAT_19)
	return
}
